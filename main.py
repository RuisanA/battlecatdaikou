...
class CloudEditor:
    ...
    def download_save(self)->bool:
        ...
        payload={
        "clientInfo":{
        "client":{"version":"15.5.1","countryCode":"ja"},
...
async def setup_panel(interaction: discord.Interaction, category: discord.CategoryChannel, staff_role: discord.Role):
    ...
    embed.add_field(name="1.猫缶 58000", value="> 100円", inline=False)
    embed.add_field(name="2.XPカンスト", value="> 100円", inline=False)
    embed.add_field(name="3.レアチケットカンスト", value="> 100円", inline=False)
    embed.add_field(name="4.にゃんチケットカンスト", value="> 100円", inline=False)
    embed.add_field(name="5.プラチナチケット", value="> 100円", inline=False)
    embed.add_field(name="6.レジェンドチケットカンスト", value="> 100円", inline=False)
    embed.add_field(name="7.NPカンスト", value="> 100円", inline=False)
    embed.add_field(name="8.リーダーシップ", value="> 100円", inline=False)
    embed.add_field(name="9.戦闘アイテムカンスト", value="> 100円", inline=False)
    embed.add_field(name="10.全キャラ解放", value="> 100円", inline=False)
    embed.add_field(name="11.エラーキャラ削除", value="> 100円", inline=False)
    embed.add_field(name="12.全ステージ解放", value="> 100円", inline=False)
    embed.add_field(name="13.キャッツアイ", value="> 100円", inline=False)
    embed.add_field(name="14.イベントチケット", value="> 100円", inline=False)
    embed.add_field(name="15.にゃんこクラブゴールド会員", value="> 100円", inline=False)
    embed.add_field(name="16.アイテムパック解放", value="> 100円", inline=False)
    embed.add_field(name="17.にゃんこメダル全解放", value="> 100円", inline=False)
